const { createTickDictionary } = require('./createDictionary');
/**
...
class CPU {
  ...
  tick() {
    ...
    const instructionDictionary = createTickDictionary(cpu, first, second);

    // !!! IMPLEMENT ME

    const handleIt = instructionDictionary[IR];
    handleIt();
